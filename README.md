...
2. **Vamos a necesitar una variable para la posición de las partículas**, a diferencia de PSO donde la posición es una coordenada, en SBPSO **estará formada por un conjunto de elementos del espacio de búsqueda (U).** La vamos a representar con Xi, donde Xi es un conjunto de ciertos elementos.
